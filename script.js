...
const summaryCards = [
  ...
  { title: "華盛頓特區旅遊", text: "國家廣場、史密森尼博物館群、林肯紀念堂、白宮與國會山莊外觀，採低負擔與親子友善節奏。" },
  { title: "費城備案", text: "若後續仍想加入費城，可作為 1 日延伸：UPenn、獨立宮與自由鐘擇重點，不列入目前主行程。" },
  { title: "紐約旅遊", text: "中央公園、AMNH、NYU、Columbia、911 紀念、自由女神、百老匯或 MLB，依體力切換版本。" }
];
...
const tripDays = [
  {
    ...
    highlight: "抵達美國後不安排觀光，保留時差調整與行李整理。",
  ...
  },
  {
    ...
    afternoon: "下午改排 DC 旅遊：史密森尼國家航空太空博物館為第一優先，若體力允許再銜接國家廣場周邊散步。",
    evening: "林肯紀念堂與倒影池夜景散步，或回朋友家檢查兩篇海報檔案、發表服裝、名片與聯絡資訊。",
    transport: "上午以步行、Metro 或短程叫車往返會場；下午用 Metro + 步行串連博物館與國家廣場，疲累時改短程叫車。",
    highlight: "上午聚焦悲傷與失落輔導；下午補入 DC 必排景點，讓 APA 與親子旅遊取得平衡。",
    meal: "午餐選會場或博物館附近；下午注意補水與室內避暑，晚餐不宜過晚。",
    notice: "8/5 只參加上午 CEWS #001，不再排下午 APA 工作坊；下午旅遊仍需保留體力給 8/6 海報發表。",
    backup: "若工作坊延後或天氣不佳，下午改為會場動線熟悉、海報準備與回朋友家休息；DC 景點移到 8/7。",
    categories: ["APA 研討會", "旅遊景點", "行前準備", "餐食建議"],
    tags: ["APA", "旅遊", "餐食", "親子友善", "備援"],
    priority: "apa"
  },
  {
    id: "2026-08-06",
  ...
  },
  {
    ...
    weekday: "五",
    city: "華盛頓特區",
    lodging: "續住華盛頓 D.C. 朋友家；依朋友家位置安排會場與景點通勤。",
    morning: "沒有海報發表，只挑 1 個最有興趣的 APA 場次，例如軍事心理、AI、心理測驗標準或創傷照護；也可選擇上午休息。",
    afternoon: "DC 旅遊加強版：補國家廣場、國會山莊外觀、白宮外觀，或安排史密森尼博物館群未完成項目。",
    evening: "林肯紀念堂、倒影池與家庭晚餐；若體力不足，回朋友家休息與整理。",
    transport: "上午會場短程移動；下午與晚間以 Metro + 步行串連 DC 景點，疲累時改叫車。",
    highlight: "8/7 不發表，採精選 APA 場次 + DC 旅遊為主，是補齊華盛頓必排景點的關鍵日。",
    meal: "下午安排咖啡與室內休息，避免連續步行造成疲勞。",
    notice: "不需要整天待在會場；只參加真正有興趣的場次，其餘時間留給親子旅遊。",
    backup: "若天氣不佳，改以史密森尼室內博物館為主；若想增加學術交流，再回會場補 poster 或 division 活動。",
    categories: ["APA 研討會", "旅遊景點", "自由活動", "餐食建議"],
    tags: ["APA", "旅遊", "餐食", "親子友善", "備援"],
    priority: "apa"
  },
  {
    ...
    morning: "上午以第二場海報準備、整理行李與確認朋友家／寄放點取行李動線為主；不再安排 DC 旅遊或耗體力場次。",
    ...
    notice: "Amtrak 不要訂 15:30 前的班次，海報交流和取行李的緩衝必須足夠；若改更晚班次，抵達紐約後不要安排任何外食，只入住休息。",
  ...
  },
  {
    ...
    evening: "可安排 Times Square 與劇院區短程夜景，或提早回飯店休息，為後面幾天保留體力。",
    transport: "地鐵為主，中央公園、AMNH 與 Times Square 之間可用地鐵或短程叫車銜接。",
    highlight: "8/8 已抵達紐約，8/9 成為完整紐約日，增加親子友善博物館、中央公園與低負擔城市適應時間。",
    meal: "午餐可安排 Upper West Side；晚餐視體力選 Times Square 周邊或飯店附近。",
    notice: "AMNH 建議事先查票務與閉館時間；第一個紐約完整日避免排滿，保留午休或回飯店時間。",
    backup: "低負擔版本只保留中央公園 + AMNH 擇一；加強版本加入 Times Square 夜景或百老匯周邊散步。",
    categories: ["旅遊景點", "自由活動", "餐食建議"],
    tags: ["旅遊", "餐食", "親子友善", "備援"],
    priority: "travel"
  },
  {
    ...
    evening: "若 MLB 官方賽程有合適場次，可安排洋基體育館球賽；若未購票、無合適場次或體力不足，改為雀兒喜市場晚餐與飯店休息。",
    transport: "地鐵為主；Pier 86、Chelsea、Yankee Stadium 跨區移動時，疲累或散場太晚可改 App 叫車。",
    highlight: "Columbia 校園、無畏號、雀兒喜市場與 MLB 晚間活動，集中在紐約段第二個完整日。",
    meal: "午餐可在 Upper West Side；晚餐可在雀兒喜市場或球場內外簡餐；看球日先準備水與輕便外套。",
    notice: "MLB 是否安排需以官方賽程、開賽時間與票券狀態為準；球場人潮多，家人集合點需事先約好。",
    backup: "若天氣或體力不佳，取消無畏號或球賽，改為飯店休息、雀兒喜市場用餐或 Times Square 短程夜景。",
    categories: ["大學參訪", "旅遊景點", "自由活動", "餐食建議"],
    tags: ["大學參訪", "旅遊", "餐食", "親子友善", "備援"],
    priority: "travel"
  },
  {
    id: "2026-08-11",
    ...
    city: "紐約",
    lodging: "續住紐約市區交通便利區域。",
    morning: "Lower Manhattan 核心景點：自由女神可選登島或砲台公園遠眺；若選登島，上午需提早出發並簡化下午行程。",
    ...
    highlight: "自由女神、911 紀念館周邊與布魯克林大橋，集中處理 Lower Manhattan 核心景點。",
  ...
  },
  {
    ...
    afternoon: "保留作為前幾天未完成景點的補位；若行程順利，可安排百老匯周邊、SoHo 或特色餐食。",
    evening: "可安排百老匯音樂劇、Times Square 夜景或提早回飯店整理返程行李。",
    transport: "地鐵為主，跨區疲累時搭計程車或 App 叫車。",
    highlight: "把 8/12 設為紐約彈性與補位日，避免連續高強度景點造成疲勞。",
    meal: "午餐與晚餐依補位景點安排；若看音樂劇，晚餐需提早。",
    notice: "若要看百老匯或補博物館票券，需事先確認時間；本日不排不可取消的硬行程。",
    backup: "若全家疲累，改成睡晚、飯店附近用餐、簡單採買與行李整理。",
    categories: ["旅遊景點", "自由活動", "餐食建議", "風險控管"],
    tags: ["旅遊", "餐食", "親子友善", "備援"],
    priority: "travel"
  },
  {
    ...
    backup: "若天氣或體力不足，取消 NYU 或補景點，只保留飯店休息、整理行李並提早到 JFK。",
    categories: ["大學參訪", "旅遊景點", "跨城市移動", "國際航班"],
    tags: ["大學參訪", "旅遊", "交通", "餐食", "備援"],
    priority: "travel"
  },
  {
    id: "2026-08-14",
    ...
    afternoon: "飛行中。整理照片、簡短記錄 APA 收穫與旅遊心得。",
    evening: "飛行中。降低螢幕使用，協助女兒調整返臺作息。",
    transport: "國際航班。",
    highlight: "返程與時差調整。",
...
const apaDailyRhythm = {
  "2026-08-05": "上午固定參加 CEWS #001 Grief and Loss 工作坊；下午不排 APA 工作坊，改走史密森尼航空太空博物館、國家廣場與林肯紀念堂夜景。",
  ...
  "2026-08-07": "無海報發表，只挑 1 個最有興趣的 APA 場次；其餘時間補 DC 旅遊、博物館、國家廣場或林肯紀念堂。",
...
const attractions = [
  ...
  { city: "華盛頓特區", name: "林肯紀念堂", reason: "最具代表性的 DC 歷史地標之一，適合傍晚拍照與親子歷史討論。", duration: "45-75 分鐘", transport: "Metro + 步行或短程叫車", date: "8/4 晚間或 APA 期間輕量安排", family: "高", low: "只走林肯紀念堂與倒影池", plus: "加入越戰紀念碑、韓戰紀念碑與華盛頓紀念碑遠眺", officialUrl: "https://www.nps.gov/linc/", ticketUrl: "", ticketNote: "免票，無需預約；夜間參觀仍需留意交通與安全。" },
  { city: "華盛頓特區", name: "史密森尼國家航空太空博物館", reason: "親子友善、室內避暑，適合 13 歲孩子同行。", duration: "2-3 小時", transport: "Metro + 步行", date: "8/4", family: "高", low: "只看重點展區", plus: "搭配自然史博物館或國家藝廊", officialUrl: "https://airandspace.si.edu/visit/museum-dc", ticketUrl: "https://airandspace.si.edu/visit/museum-dc/guidelines", ticketNote: "需預約免費 timed-entry pass；熱門時段建議提早確認可用票券。" },
  ...
  { city: "紐約", name: "中央公園", reason: "紐約最具代表性的親子友善戶外空間，可作為 AMNH 前後的休息緩衝。", duration: "1.5-2.5 小時", transport: "地鐵或短程叫車", date: "8/9", family: "高", low: "Sheep Meadow 或 Bethesda Terrace 輕量散步", plus: "加入湖區、Belvedere Castle 或更多拍照點", officialUrl: "https://www.centralparknyc.org/", ticketUrl: "", ticketNote: "一般入園免票，無需預約；特定活動或設施另依官方公告。" },
  { city: "紐約", name: "美國自然史博物館 AMNH", reason: "親子友善且教育性高，適合 13 歲孩子同行，與中央公園可順路安排。", duration: "2.5-4 小時", transport: "地鐵或短程叫車", date: "8/9", family: "高", low: "只看恐龍、海洋、宇宙等重點展區", plus: "加入特色展或天文館，需事先查票務", officialUrl: "https://www.amnh.org/", ticketUrl: "https://tickets.amnh.org/select", ticketNote: "建議先查一般門票、特展與入場時段；熱門日期提早購票。" },
  ...
  { city: "紐約", name: "自由女神", reason: "紐約最具代表性的城市地標，適合作為 Lower Manhattan 核心景點。", duration: "2.5-4 小時", transport: "地鐵至 Lower Manhattan + 渡輪", date: "8/11 上午", family: "中高", low: "砲台公園遠眺與拍照", plus: "登島或含 Ellis Island 船票，需事先預約", officialUrl: "https://www.nps.gov/stli/planyourvisit/index.htm", ticketUrl: "https://www.cityexperiences.com/new-york/city-cruises/statue2/", ticketNote: "NPS 指定 Statue City Cruises 為授權票券與登島渡輪；請避免第三方加價票券。" },
  ...
  { city: "紐約", name: "雀兒喜市場", reason: "餐食選擇多、室內為主，適合無畏號或看球前後補給。", duration: "1-1.5 小時", transport: "地鐵、步行或短程叫車", date: "8/10 下午或晚餐", family: "高", low: "只用餐與短暫逛街", plus: "加入 High Line 或 Little Island", officialUrl: "https://www.chelseamarket.com/", ticketUrl: "https://www.chelseamarket.com/visit", ticketNote: "一般入場免票；個別店家營業時間、餐廳訂位或活動需另查官方資訊。" },
  { city: "紐約", name: "無畏號航空母艦博物館", reason: "軍事、航空與太空元素明確，與孩子興趣及軍事心理學背景都能連結。", duration: "2-3 小時", transport: "地鐵後步行或短程叫車至 Pier 86", date: "8/10 下午", family: "高", low: "只看航空母艦與甲板重點", plus: "加入潛艦、航太展區與更多展覽", officialUrl: "https://intrepidmuseum.org/plan-your-visit/visitor-information/tickets", ticketUrl: "https://intrepidmuseum.org/plan-your-visit/visitor-information/tickets", ticketNote: "官方頁同時提供參觀資訊與票券；建議先查開放時間與特殊展覽。" },
  { city: "紐約", name: "MLB 洋基體育館球賽", reason: "具代表性的美國運動文化體驗，適合親子同行作為紐約晚間亮點。", duration: "3-4 小時", transport: "地鐵至 Yankee Stadium，散場視人潮可改叫車", date: "依官方賽程，優先 8/11 或 8/12 晚間", family: "中高", low: "只參觀球場周邊或看部分局數", plus: "購票完整觀賽；2026/8/11-8/13 洋基主場對西雅圖賽程需以 MLB／洋基官方最後公告為準", officialUrl: "https://www.mlb.com/yankees/tickets/2026", ticketUrl: "https://www.mlb.com/yankees/tickets/single-game-tickets", ticketNote: "賽程、開賽時間與票券釋出仍以 MLB／洋基官方最後公告為準。" }
];

const transportPlans = [
  { route: "租車 vs Amtrak 判斷", method: "不建議租車作為主方案；建議 Amtrak + 市區交通 + 必要時短程叫車。", time: "Amtrak NYC-DC 約 3-3.5 小時；自駕常受進出城塞車與停車影響。", pros: "Amtrak 市中心到市中心，不需處理停車與跨城還車，適合 APA 與家庭同行。", cons: "Amtrak 需配合班次與票價；但整體仍比租車省心。", family: "APA 發表日不建議自行開車長途移動，避免疲勞與時間壓力。", luggage: "火車行李集中管理；租車需處理取還車與停車搬運。", backup: "若 Amtrak 異常，才考慮巴士、預約接送或臨時租車。" },
  { route: "JFK 至首晚住宿", method: "AirTrain 至 Terminal 5 + 空橋步行至 TWA Hotel", time: "航廈間 AirTrain 約數分鐘，實際時間視入境與領行李而定", pros: "深夜抵達最省力，無須叫車進城；TWA Hotel 位於 JFK 航廈區，適合第一晚直接休息。", cons: "TWA Hotel 價格可能較高，暑假旺季需早訂；若選 JFK 周邊連鎖飯店，需確認免費接駁方式與末班時間。", family: "一家三口與大件行李建議優先考慮 TWA Hotel 或 JFK 周邊接駁飯店，避免第一晚深夜進曼哈頓。", luggage: "TWA Hotel 可減少行李搬運與夜間轉乘；若進曼哈頓，行李少時才建議 AirTrain + LIRR。", backup: "JFK 周邊有免費接駁的連鎖飯店；若住曼哈頓，可搭 AirTrain → Jamaica → LIRR → Penn Station 或預約接送。" },
  ...
  { route: "華盛頓特區市區移動", method: "Metro + 步行 + 短程叫車", time: "視朋友家位置與距離約 10-60 分鐘", pros: "住朋友家可降低住宿成本；景點與會場移動可用 Metro、步行與短程叫車組合。", cons: "實際通勤時間取決於朋友家位置，APA 海報日需提早出門並預留回程取行李時間。", family: "午後安排室內博物館；若朋友家離 Metro 較遠，晚間回程優先叫車。", luggage: "會議日不拖行李；8/8 需事先確認行李放在朋友家或可寄放點。", backup: "疲累、天氣差或晚間回程時改 Uber/Lyft。" },
  { route: "華盛頓特區至紐約", method: "Uber/Lyft 銜接 + Amtrak", fromStation: "Washington Union Station (WAS)", fromAddress: "50 Massachusetts Avenue NE, Washington, DC 20002-4214", toStation: "Moynihan Train Hall at Penn Station (NYP)", toAddress: "351 West 31st Street, New York, NY 10001", time: "建議 16:30 或 17:00 後班次；WAS → NYP 約 3-3.5 小時", pros: "8/8 海報結束後直接進紐約，少一次換住宿；會場 → 朋友家／寄放點 → Union Station 以叫車銜接較穩。", cons: "票價需早訂；不可訂 15:30 前班次，避免海報交流、拆海報、取行李與到車站時間不足。", family: "抵達紐約後只入住與休息，不安排晚間外食或正式景點。", luggage: "大件行李建議放朋友家或預先確認可寄放點；海報後先 Uber/Lyft 取行李，再叫車到 Washington Union Station。", backup: "若海報收拾、取行李或交通延誤，改搭較晚 Amtrak；抵達紐約後取消所有外出。" },
...
const lodgingPlans = [
  ...
  { city: "華盛頓特區", area: "暫定住朋友家，不另規劃 DC 飯店", priority: "已暫定", reason: "可降低住宿成本，也方便全家在 APA 期間有固定休息點；不在網站放朋友家地址、門牌或電話。", note: "出發前需確認朋友家至 Walter E. Washington Convention Center、Washington Union Station 與主要 Metro 站的實際通勤時間；8/8 需先確認行李放置與取行李動線。" },
  { city: "紐約", area: "Midtown、Upper West Side、Chelsea 或交通安全便利區", priority: "第二優先", reason: "8/8 起連住紐約，可銜接 Columbia、NYU、AMNH、百老匯、MLB 與 JFK 交通。", note: "8/8 抵達後只安排入住休息；8/13 晚間需規劃行李寄放與前往 JFK。" },
...
const photoGuideItems = [
  {
    ...
    family: "適合親子同行，但夏季需補水並避開正午長時間曝曬。",
  ...
  },
  {
    ...
    name: "史密森尼國家航空太空博物館",
    date: "8/4、8/7",
    focus: "適合親子同行與暑期避暑，能把科學、探索與美國太空史放進較輕量的室內行程。",
  ...
  },
  {
    ...
    name: "獨立宮",
    date: "費城一日延伸備案",
    focus: "費城歷史核心景點，若未來加回費城，可與自由鐘、Independence Visitor Center 和舊城區步行路線搭配。",
  ...
  },
  {
    ...
    name: "自由鐘",
    date: "費城一日延伸備案",
    focus: "與獨立宮一起構成費城歷史軸線；保留為未來加回費城時的短時間代表性景點。",
  ...
  },
  {
    ...
    name: "美國自然史博物館 AMNH",
    date: "8/9",
    focus: "可與中央公園和 Upper West Side 串接，是紐約段最親子友善的室內主景點之一。",
  ...
  },
  {
    ...
    family: "對 13 歲孩子可能較沉重，可只安排紀念池周邊並視狀態決定是否入館。",
  ...
  },
  {
    ...
    date: "8/9 或 8/12 晚間",
    focus: "作為百老匯、晚餐與紐約夜間地標的視覺預覽，適合安排短時間停留。",
  ...
  },
  {
    ...
    name: "雀兒喜市場",
    date: "8/10 下午或晚餐",
    focus: "適合作為無畏號或看球前後的餐食補給點，也能和 High Line、Little Island 串成輕量散步路線。",
  ...
  },
  {
    ...
    name: "無畏號航空母艦博物館",
    date: "8/10 下午",
    focus: "軍事、航空與太空元素明確，可安排為紐約段兼具親子興趣與學術背景連結的景點。",
  ...
  },
  {
    ...
    focus: "作為美國運動文化體驗的視覺預覽；若實際購票，需以 MLB／洋基官方最後賽程與開賽時間為準。",
    family: "觀賽日需預留進場、安檢、散場人潮與回程時間；若太累可只保留球場周邊或取消。",
...
const riskItems = [
  ...
  { title: "跨城市交通延誤", risk: "火車或巴士誤點，壓縮景點與入住時間。", prevention: "移動日不排高密度活動，重要班次提早訂票。", action: "查看下一班交通與退改規則，通知住宿。", backup: "取消當日下午景點，改為入住、用餐與休息。" },
  { title: "APA 場次更動", risk: "想參加的場次時間、地點或格式改變。", prevention: "每天早上查 APA 官方 app 或議程系統。", action: "改選同主題場次、海報區或 division 活動。", backup: "以海報發表與核心交流優先，旅遊行程自動讓位。" },
  { title: "海報發表時間異動", risk: "發表時間或位置變動，造成準備不足。", prevention: "前一晚與當天早上再次確認官方資訊。", action: "立即調整行程，通知家人並保留會場時間。", backup: "取消當天觀光與晚間活動，專注完成發表。" },
  { title: "大學參訪無法成行", risk: "天氣、交通或校園管制導致參訪縮短。", prevention: "大學參訪皆設定為建議安排，不當成硬性會議。", action: "改為校園外圍、書店、公共空間或線上資料蒐集。", backup: "以附近景點或休息取代。" },
  { title: "住宿或交通取消", risk: "訂房或車票異常，造成臨時改訂。", prevention: "保存確認信，選可取消或高評價供應商。", action: "先確保當晚住宿，再處理退款與客訴。", backup: "準備同區 2-3 個備用住宿區域與交通方案。" },
  { title: "身體不適或突發狀況", risk: "時差、熱傷害、腸胃不適或過度疲累。", prevention: "每日安排補水、室內休息與低負擔版本。", action: "停止行程，回住宿休息；必要時尋求醫療協助。", backup: "旅遊行程可刪減，APA 發表保留最小必要出席。" },
  { title: "文件遺失", risk: "護照、證件、票券或 APA 文件遺失。", prevention: "紙本與雲端備份分開保存，重要文件隨身。", action: "立即回溯地點、聯絡住宿與交通單位。", backup: "聯繫駐美相關單位與保險公司，使用備份文件處理。" },
  { title: "手機遺失", risk: "無法聯絡、導航、取票或付款。", prevention: "設定螢幕鎖、裝置尋找、重要資料雲端同步。", action: "使用家人手機定位、鎖定裝置並停用支付。", backup: "準備紙本行程、住宿地址與緊急聯絡卡。" },
  { title: "網路中斷", risk: "無法導航、查票或聯絡。", prevention: "eSIM + 漫遊或實體 SIM 備援，下載離線地圖。", action: "前往飯店、咖啡店或車站 Wi-Fi 查詢。", backup: "使用紙本地址、截圖票券與預先下載資料。" },
  { title: "信用卡無法使用", risk: "付款失敗或風控鎖卡。", prevention: "攜帶至少兩張卡與少量現金，出國前通知銀行。", action: "改用另一張卡或現金，聯絡銀行解鎖。", backup: "家人分散持有付款工具。" },
  { title: "天氣不佳", risk: "戶外景點取消或交通受影響。", prevention: "每天查看天氣，戶外行程安排室內替代。", action: "改去博物館、圖書館、校園室內周邊或提早休息。", backup: "DC 用史密森尼，紐約用 AMNH、百老匯或室內購物餐食；費城目前只作備案，不影響主線。" },
  { title: "親子同行臨時疲累", risk: "步行過量、時差或情緒疲勞影響全家節奏。", prevention: "每日保留低負擔版本與下午休息。", action: "刪減景點，只保留一個核心活動。", backup: "回住宿休息、外帶晚餐或改搭叫車。" }
];
    ...
    <article class="day-card priority-${day.priority}" data-date="${day.id}" data-categories="${day.categories.join("|")}" data-priority="${day.priority}">
      ...
      <div class="day-detail">
        <div class="detail-grid">
          ...
          <div class="detail-box"><strong>旅遊重點</strong>${day.highlight}</div>
...
function renderAttractions() {
  ...
  grid.innerHTML = attractions.map((item) => `
    <article class="info-card">
      ...
      <p><strong>推薦理由：</strong>${item.reason}</p>
      <p><strong>建議停留：</strong>${item.duration}</p>
      <p><strong>交通方式：</strong>${item.transport}</p>
      <p><strong>適合日期：</strong>${item.date}</p>
      <p><strong>親子友善：</strong>${item.family}</p>
...
function updatePhotoGuide(index) {
  ...
  detail.innerHTML = `
    ...
    <p class="ticket-note"><strong>維護提醒：</strong>此區使用一般 JPG/PNG 圖片即可。新增照片時請同步保留作者、授權與來源連結。</p>
  `;
...
function renderTransport() {
  ...
  if (!grid) return;
  grid.innerHTML = transportPlans.map((item) => `
