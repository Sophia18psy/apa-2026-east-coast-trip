...
這是一個純 HTML、CSS、JavaScript 製作的靜態互動網站，用於查詢 2026/8/2-8/15 APA 2026 研討會、海報發表、東岸學術參訪、大學參訪、交通住宿、行前準備與風險備援。目前主線為 JFK、費城、華盛頓特區、紐約、JFK；8/3 安排賓州大學心理學系／校園自助參訪與 Phillies 主場球賽，8/11 安排 Yankee Stadium Tour 與 Mariners @ Yankees 球賽。
...
飯店預訂清單在 `script.js` 的 `hotelBookingPlans` 陣列，住宿區域摘要在 `lodgingPlans` 陣列。
...
請不要把完整住宿地址、訂單編號、付款卡號、護照資料或朋友家私人資訊寫進網站。可把確認信留在 email 或私人雲端資料夾，網站只保留「已訂／待預訂／備援」與取消期限提醒。
